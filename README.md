...
The pipeline will preprocess, generate the patches and run the added segmentation tools (moddify "**../nextflow/main.nf**" to adapt any preprocessing step or the selection of segmentation tools).
